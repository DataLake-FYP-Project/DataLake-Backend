...
def process_frame_data(df):
    ...
    default_config = {
        ...
        "timestamp_fields": ["entry_time", "exit_time", "red_light_violation_time", "line_crossing_violation_time", "vehicle_entry_time", "vehicle_exit_time"],  
        "preserve_null_fields": ["entry_time", "exit_time", "red_light_violation_time", "line_crossing_violation_time", "vehicle_entry_time", "vehicle_exit_time"]
    }
