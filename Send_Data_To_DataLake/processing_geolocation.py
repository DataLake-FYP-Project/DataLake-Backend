...
def geolocation_upload_to_elasticsearch(file_path):
    try:
        ...
        for i, detection in enumerate(detections):
            ...
            es.index(index=ES_INDEX, id=i + 1, body=record, pipeline="geolocation_data_timestamp_pipeline")
            print(f"Uploaded doc {i + 1} to Elasticsearch")

    except Exception as e:
        print(f"Error uploading geolocation data: {e}")
